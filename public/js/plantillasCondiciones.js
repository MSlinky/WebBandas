function info(url){
	if(url[0] == 'es'){
		if('/'+url[1]+'/'+url[2] =="/GarantiasCondiciones/Huevo"){
			$('.textBanner').html("Garantía y Condiciones <br> Banda de Huevo");
			$('.banner').css({
				"background-image": "url(/public/imgs/banners/Portada_garantias_banda_huevo.jpg)"
			});
		...
		}else if('/'+url[1]+'/'+url[2] =="/GarantiasCondiciones/Gallinaza"){
			$('.textBanner').html("Garantía y Condiciones <br> Banda de Gallinaza");
			$('.banner').css({
				"background-image": "url(/public/imgs/banners/Portada_garantias_banda_gallinaza.jpg)"
			});
